								...
								return (
									<tr key={key}>
										...
										{order.status === "pending" ? (
											<td className='order-table-values'>
												<strong className='pending-btn'>{order.status}</strong>
											</td>
										) : order.status === "completed" ? (
											<td className='order-table-values'>
												<strong className='completed-btn'>
													{order.status}
												</strong>
											</td>
										) : (
											<td className='order-table-values'>
												<strong className='prepared-btn'>{order.status}</strong>
											</td>
										)}
										{order.status === "prepared" ? (
											<td className='order-table-values'>
												<button
													...
													className='mark-as-completed-btn'
												>
													MARK AS COMPLETED
												</button>
											</td>
