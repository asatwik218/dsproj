...
function EditItem({ match }) {
	...
	return (
		<div className='manage-items-page'>
			<AdminNavbar />
			<h1>Editing The Details of '{item.title}'</h1>
			<br />
			...
			<form onSubmit={editItem}>
				...
				<div className='row'>
					...
					<div className='col-75'>
						<input
							...
							id='img'
							name='img'
							placeholder='Link of a relatable image for your item'
							required
							value={item.img}
							onChange={onChangeInput}
						/>
				...
				<div className='row'>
					...
					<div className='col-75'>
						<input
							...
							id='price'
							name='price'
							placeholder='The Price of Your Dish'
							required
							value={item.price}
							onChange={onChangeInput}
						/>
				...
				<br />
				<div className='row'>
					<button className='item-post' type='submit'>
						UPDATE
					</button>
				</div>
			</form>
