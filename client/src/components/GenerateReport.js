...
const GenerateReport = () => {
	...
	return (
		<div className='reports-page'>
			...
			<br />
			<br />
			<h3>Total Income Generated (Lifetime) : INR {totalIncome()}</h3>
			<br />
			<h3>Total Number of Orders : {totalOrder}</h3>
			<br />
			<h3>Income Generated in the Current Month = INR {currentIncome}</h3>
			<br />
			<h3>Income Generated in the Last Month = INR {prevIncome}</h3>
			<br />
